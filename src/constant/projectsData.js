export const SECTION_TITLE = "Meine Projekte";
...
export const PROJECTS_DATA = [
    {
        id: 1,
        title: "NASA APOD React-App",
        description: "Eine kleine nette Webseite, die täglich Benutzer mit einem astronomischen Bild oder Video begeistert, das direkt von der NASA's Astronomy Picture of the Day (APOD) API stammt.",
        tech: "react_logo",
        githubLink: "https://github.com/ArnoldTauscher/weltraum-app",
        githubReadmeLink: "https://github.com/ArnoldTauscher/weltraum-app/blob/main/README.md",
        imageUrl: "nasa_apod",
        projectLink: "https://weltraum-react-app.netlify.app/"
    },
    {
        id: 2,
        title: "Restaurant Gerícht",
        description: 'Diese React-App bietet eine benutzerfreundliche und interaktive Oberfläche, die es Restaurantbesuchern ermöglicht, Informationen zu finden, die Speisekarte zu durchstöbern und Tische zu reservieren, alles in einem modernen und ansprechenden Design.',
        tech: "react_logo",
    ...
    },
    {
        ...
        projectLink: "https://purrrsche.onrender.com/"
    },
    {
        id: 4,
